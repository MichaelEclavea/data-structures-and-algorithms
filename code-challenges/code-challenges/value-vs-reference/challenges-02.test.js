...
Write a function named raisedToTheThird that takes in an array of numbers and returns a new array of each of those numbers
...
const addBirthYearProperty = (obj, year) => {
 let object = obj;
 let date = year;
 let first = 'fullName: ' + obj; 
 let second = 'yearBorn: ' + year;
