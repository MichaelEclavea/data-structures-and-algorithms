...
const oddValues = (arr) => {
   const odds = arr.filter(even => even % 2 !== 0)
 return odds;
};
...
const filterStringsWithVowels = (arr) => {
   let vowels = /[aeiou]/g;
   let vowelWords = arr.filter(word => word.match(vowels));
   return vowelWords;
};
...
and an integer as input, uses filter to return an array containing all stats with a baseStat 
...
function from challenge 4. For this function, extend your solution from challenge 4 to only return 
