...
Without altering the html, write a function named generateSubmitButton that uses jQuery to create a submit button with the
 text "submit" and append it to the DOM.
------------------------------------------------------------------------------------------------ */
...
const generateSubmitButton = () => {
  ...
  let button = $('<button type="button">submit</button>')
